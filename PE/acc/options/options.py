...
parser.add_argument("--node_length", default=256, type=int, help="")
parser.add_argument("--graph_layer_num", default=1, type=int, help="")
...
parser.add_argument("--test_set", type=str, default="neo", help="")
